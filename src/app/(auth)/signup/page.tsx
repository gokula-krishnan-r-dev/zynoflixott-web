  ...
  return (
    <div className="bg-black ">
      <div className="min-h-screen  text-gray-900 flex justify-center relative">
        ...
        <div className="absolute z-20 inset-0 w-full h-full bg-black opacity-70 hidden [.ios &]:block"></div>
              ...
              <div className="w-full flex-1 mt-8">
                <div className="flex flex-col items-center">
                  ...
                  <Link
                    ...
                    className="w-full mt-4 max-w-xs font-bold text-center shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline"
                  >
