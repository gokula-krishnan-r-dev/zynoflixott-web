...
const page = () => {
  ...
  return (
    <div>
      <div className="min-h-screen text-gray-900 bg-black flex justify-center relative">
        {/* <video
          loop
            ...
            <div className="mt-12 flex flex-col items-center">
              ...
              <div className="w-full flex-1">
                {/* <div className="flex flex-col items-center">
                  <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3   bg-indigo-100 text-gray-800   border-0 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
